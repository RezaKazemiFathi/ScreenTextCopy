...
ScreenTextCopy community a harassment-free experience for everyone, regardless of
...
Because this project is bilingual and used across many regions, one addition to the
list above: mocking someone's spelling, grammar, or command of English, Persian or
Arabic is treated as harassment. Not everyone writes in their first language here.
...
comments, commits, code, issues, pull requests, wiki edits, and other contributions
that are not aligned to this Code of Conduct, and will communicate reasons for
moderation decisions when appropriate.

For this project, the maintainer — **Reza Kazemi Fathi** — fills the community
leader role.
...
For ScreenTextCopy specifically, community spaces include the GitHub repository —
issues, pull requests, code review comments, discussions and commit messages — and
any project-related conversation on the maintainer's
[GitHub](https://github.com/rezakazemifathi),
[Instagram](https://instagram.com/rkfcode) or
[YouTube](https://youtube.com/rkfcode) channels.

## Reporting

If you experience or witness unacceptable behavior, report it to the maintainer,
**Reza Kazemi Fathi**, through GitHub at
[@rezakazemifathi](https://github.com/rezakazemifathi) — use the private contact
options listed on that profile rather than a public issue, so the report stays
between you and the maintainer.

Please include what happened, where, and links if the behavior is on GitHub. All
complaints will be reviewed and investigated promptly and fairly, and the privacy
and security of the reporter will be respected. This is a volunteer project, so
allow a few days for a response.

If the report concerns the maintainer, or you would rather not contact them
directly, GitHub's own abuse reporting at
<https://github.com/contact/report-abuse> is available and independent of this
project.

Note that this channel is for conduct issues only. **Security vulnerabilities go
through [SECURITY.md](SECURITY.md) instead**, and should never be filed as a public
issue.
